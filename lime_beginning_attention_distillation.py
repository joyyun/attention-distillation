...
model.load_state_dict(torch.load(
    'checkpoints/distilbert_distfinetune_attention_bert-2023_06_10-00_59.pth'))  # change path

class_names = ['unacceptable', 'acceptable']

print("running lime on distilbert beginning attention distillation...")
...
print(tokenizer(text1, return_tensors='pt', padding=True))


explainer = LimeTextExplainer(class_names=class_names)
exp = explainer.explain_instance(
    text1, predictor, num_features=5, num_samples=200)
exp.save_to_file('./lime_test_distilbert_attention_distill1.html')
