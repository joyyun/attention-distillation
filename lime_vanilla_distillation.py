...
model.load_state_dict(torch.load(
    'checkpoints/distilbert_distfinetune_logits_bert-2023_06_09-23_35.pth'))  # change path

class_names = ['unacceptable', 'acceptable']

print("running lime on distilbert vanilla distillation...")
...
exp.save_to_file('./lime_test_distilbert_vanilla_distill4.html')
