...
model.load_state_dict(torch.load(
    'checkpoints/distilbert_finetune_retry-2023_06_09-23_32.pth'))

class_names = ['unacceptable', 'acceptable']

print("running lime on finetuned distilbert...")
...
exp.save_to_file('./lime_test_distilbert_finetune4.html')
